...
<div class="container">
    <div class="panel">
        ...
        <div class="con_body">
            ...
            <form action="<?php echo appUrl('UserManage/add'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td width="">
                            <input name="username" class="txt" id="username" value="<?php echo ($obj["username"]); ?>" style="width:150px;" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" width="130px;">用户密码：</th>
                        <td width="">
                            <input name="password" class="txt" id="password" value="<?php echo ($obj["password"]); ?>" style="width:150px;" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="">
                            <select name="group_id" id="group_id" style="width:150px;">
                                ...
                                <?php if(is_array($groupList)): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i; if($item[group_id]!=1){ ?>
                                    <option value="<?php echo ($item["group_id"]); ?>" <?php if($obj['group_id']==$item['group_id']){ ?> selected="selected"<?php } ?>><?php echo ($item["group_name"]); ?></option>
