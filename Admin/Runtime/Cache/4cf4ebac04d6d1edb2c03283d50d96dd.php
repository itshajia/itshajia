            ...
            <form action="<?php echo appUrl('Article/noteCate'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="" href="<?php echo appUrl('Article/noteCate/view/add'); ?>/catid/<?php echo ($item["catid"]); ?>">编辑</a>
                                <a class="" onclick="return cfirm();" href="<?php echo appUrl('Article/noteCate/view/del'); ?>/catid/<?php echo ($item["catid"]); ?>"></span>删除</a>
                            </td>
                    ...
                    <tr class="no_line">
                        <td colspan="6">
                            <div class="clearfix">
                                <button type="button" class="uio_btn" onclick="location.href='/Admin/Article/noteCate/view/add'">添加</button>
