...
<div class="container">
    <div class="panel">
        ...
        <div class="con_body">
            ...
            <form action="<?php echo appUrl('m=Application&a=type&view=add'); ?>" method="post" id="frm" name="frm">
                <input type="hidden" name="submit" value="1" />
                <table cellpadding="0" cellspacing="0" border="0">
                    <tbody>
                    <tr>
                        <th scope="row" width="130px;">应用分类名称：</th>
                        <td width="">
                            <input name="type_name" class="txt" id="type_name" value="<?php echo ($obj["type_name"]); ?>" datatype="*" nullmsg="请填写应用分类名称！" style="width:150px;" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" width="130px;">应用分类Tag：</th>
                        <td>
                            <input name="type_ename" class="txt" id="type_ename" value="<?php echo ($obj["type_ename"]); ?>" datatype="*" nullmsg="请填写应用分类Tag！" style="width:150px;" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr class="no_line">
                        ...
                        <td>
                            <?php if($obj){ ?>
                            <input type="hidden" name="type_id" id="type_id" value="<?php echo ($obj['type_id']); ?>" />
                            <?php } ?>
