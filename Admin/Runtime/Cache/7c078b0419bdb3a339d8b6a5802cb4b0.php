...
<head>
    ...
    <link rel="stylesheet" href="<?php echo (APP_NAME); ?>/Resource/Css/admin.css" />
...
<!--后台管理工具栏 end-->
    <div class="frame_box">
        <div class="frame_panel">
            <iframe id="display_frame" name="display_frame"  scrolling="auto"  src="<?php echo appUrl('m=Main&a=index'); ?>"
...
<script>
    seajs.use('<?php echo (APP_NAME); ?>/Resource/Js/admin');
</script>
</body>
</html>