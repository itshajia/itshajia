...
<div class="container">
    <div class="panel">
        ...
        <div class="con_body">
            ...
            <form action="<?php echo appUrl('Develop/menu/view/resource/op/add'); ?>" method="post" id="addFrm" name="addFrm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td width="">
                            ...
                            <?php } else { ?>
                            <select name="submenu_id" id="submenu_id" style="width:160px;">
                    ...
                    <tr>
                        ...
                        <td width="">
                            <input name="resource_name" class="txt" id="resource_name" value="<?php echo ($obj["resource_name"]); ?>" style="width:150px;" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" width="130px;">菜单项Module：</th>
                        <td width="">
                            <input name="mod" class="txt" id="m" value="<?php echo ($obj["mod"]); ?>" style="width:150px;" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" width="130px;">菜单项Action：</th>
                        <td width="">
                            <input name="act" class="txt" id="a" value="<?php echo ($obj["act"]); ?>" style="width:150px;" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" width="130px;">菜单项URL：</th>
                        <td width="">
                            <input name="resource_url" class="txt" id="resource_url" value="<?php echo ($obj["resource_url"]); ?>" style="width:300px;" />
                        </td>
                    </tr>
                    <tr>
