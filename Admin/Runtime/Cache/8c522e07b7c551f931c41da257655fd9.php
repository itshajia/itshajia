...
<div class="container">
    <div class="panel">
        ...
        <div class="con_body">
            ...
            <form action="<?php echo appUrl('m=User&a=list'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <?php if(is_array($userList)): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a href="<?php echo appUrl('m=User&a=add'); ?>&uid=<?php echo ($item["uid"]); ?>">编辑</a>
                                <a href="<?php echo appUrl('m=User&a=userList&op=disabled'); ?>&uid=<?php echo ($item["uid"]); ?>"><?php if($item['status']==1){ ?>禁用<?php }else{ ?>启用<?php } ?></a>
                                <a onclick="return cfirm();" href="<?php echo appUrl('m=User&a=userList&op=del'); ?>&uid=<?php echo ($item["uid"]); ?>">删除</a>
                            </td>
                    ...
                    <tr class="no_line">
                        <td colspan="6">
                            <div class="clearfix">
                                <button type="button" class="uio_btn" onclick="location.href='<?php echo appUrl('m=User&a=add'); ?>'">添加</button>
