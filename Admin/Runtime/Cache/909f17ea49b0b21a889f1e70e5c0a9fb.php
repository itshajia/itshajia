...
<div class="container">
    <div class="panel">
        ...
        <div class="con_body">
            ...
            <form action="<?php echo appUrl('m=Admin&a=add'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <th scope="row" width="130px;">联系电话：</th>
                        <td>
                            <input name="mobile" class="txt" id="mobile" value="<?php echo ($obj["mobile"]); ?>" datatype="*" nullmsg="请填写联系电话！" style="width:150px;" />
                        </td>
                    </tr>
                    <tr class="no_line">
                        <th></th>
