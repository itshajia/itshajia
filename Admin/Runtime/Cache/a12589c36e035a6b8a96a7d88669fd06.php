...
<div class="container">
    <div class="panel">
        ...
        <div class="con_body">
            ...
            <form action="<?php echo appUrl('m=Develop&a=menu&view=resource'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <?php if(is_array($resourceList)): $i = 0; $__LIST__ = $resourceList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="" href="<?php echo appUrl('m=Develop&a=menu&view=resource&op=add'); ?>&resource_id=<?php echo ($menu["resource_id"]); ?>&submenu_id=<?php echo ($_GET['submenu_id']); ?>&isSelect=1">编辑</a>
                                <a class="" onclick="return cfirm();" href="<?php echo appUrl('m=Develop&a=menu&view=resource&op=del'); ?>&resource_id=<?php echo ($menu["resource_id"]); ?>&submenu_id=<?php echo ($_GET['submenu_id']); ?>">删除</a>
                            </td>
                    ...
                    <tr class="no_line">
                        <td colspan="6">
                            <div class="clearfix">
                                <button type="button" class="uio_btn" onclick="location.href='<?php echo appUrl('m=Develop&a=menu&view=resource&op=add'); ?>&submenu_id=<?php echo ($_GET[submenu_id]); ?>'">添加</button>
