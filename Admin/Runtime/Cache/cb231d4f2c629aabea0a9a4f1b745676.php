            ...
            <form action="<?php echo appUrl('m=UserManage&a=customList'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <?php if(is_array($groupList)): $i = 0; $__LIST__ = $groupList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="" href="<?php echo appUrl('m=UserManage&a=groupAdd'); ?>&group_id=<?php echo ($item["group_id"]); ?>">编辑</a>
                                <a class="" onclick="return cfirm();" href="<?php echo appUrl('m=UserManage&a=groupList&op=del'); ?>&group_id=<?php echo ($item["group_id"]); ?>">删除</a>
                            </td>
                    ...
                    <tr class="no_line">
                        <td colspan="6">
                            <div class="clearfix">
                                <button type="button" class="uio_btn" onclick="location.href=<?php echo appUrl('m=UserManage&a=groupAdd'); ?>">添加</button>
