            ...
            <form action="<?php echo appUrl('m=Admin&a=groupAdd'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td width="">
                            <input name="group_name" class="txt" id="group_name" value="<?php echo ($obj["group_name"]); ?>" datatype="*" nullmsg="请填写用户组名称！" style="width:150px;" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" width="130px;">权限：</th>
                        <td width="" class="lineh_25">
                            <?php if(is_array($leftMenu)): $i = 0; $__LIST__ = $leftMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i; if( $menu['tag']!='shortcuts' && $menu['tag']!='develop' ){ ?>
