...
<div class="container">
    <div class="panel">
        ...
        <div class="con_body">
            ...
            <form action="<?php echo appUrl('m=Develop&a=menu&view=nav'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <?php if(is_array($menuListO)): $i = 0; $__LIST__ = $menuListO;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="" href="<?php echo appUrl('m=Develop&a=menu&view=nav&op=add'); ?>&menu_id=<?php echo ($menu["menu_id"]); ?>">编辑</a>
                                <a class="" onclick="return cfirm();" href="<?php echo appUrl('m=Develop&a=menu&view=nav&op=del'); ?>&menu_id=<?php echo ($menu["menu_id"]); ?>">删除</a>
                                <a class="" href="<?php echo appUrl('m=Develop&a=menu&view=sub'); ?>&menu_id=<?php echo ($menu["menu_id"]); ?>">子菜单</a>
                            </td>
                    ...
                    <tr class="no_line">
                        <td colspan="6">
                            <div class="clearfix">
                                <button type="button" class="uio_btn" onclick="location.href='<?php echo appUrl('m=Develop&a=menu&view=nav&op=add'); ?>'">添加</button>
