...
class CommonModel extends Model{
     ...
     * );
     */
    public function getUnlimit( $parent_id=0, $i=-1, $parent_id_name='parent_id', $cate_id_name='cate_id' ,$order=array('listorder') ) {
        $i++;
        ...
        foreach( $Unlist as $k=>$v ) {
            ...
            $Unlist[$k]['children'] = $this->getUnlimit( $v[$cate_id_name], $i );
            $Unlist[$k]['level'] = $i;
        }
        return $Unlist;
    }
