...
<div class="headTop font_yahei">
    <ul>
        <li class="topItem" style="width:19%;"><a href="javascript:;" class="goback" title="返回" onclick="history.go(-1);"></a></li>
        <li class="topItem" style="width:60%;">
        ...
        <li class="topItem noLine" style="width:19%;"><a href="javascript:;" class="refresh" title="刷新" onclick="location.reload();"></a></li>
    </ul>
</div>
<!-- headTop End -->

<!-- 内容主体 Start -->
<div class="container font_yahei">
    <div class="news">
        <ul class="newsGroup" id="newsGroup">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><li class="newsItem"><a href="<?php echo ($item["linkurl"]); ?>"><?php echo ($item["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    ...
    <div class="pagination clearfix">
        <div>
            <a href="javascript:;" id="moreNews" class="">获取更多</a>
        </div>
...
<script>
    seajs.use('__APP_H_JS__/app', function( App ) {
        ...
        App.headMenu();
        // 新闻列表异步获取
        App.moreNews("<?php echo $_GET['uid']; ?>");
        // 分享
        App.share();
    });
</script>
