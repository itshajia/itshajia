...
<div class="container">
    <div class="panel">
        ...
        <div class="con_body">
            ...
            <form action="<?php echo appUrl('m=Index&a=page'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                            <td><input type="checkbox" class="checkbox" name="id[<?php echo ($item["page_id"]); ?>]" /><?php echo ($item["page_id"]); ?></td>
                            <td class="no_lineH"><a href="javascript:;" class=""><?php echo ($item["title"]); ?></a></td>
                            <td><?php echo format_time($item['addtime']); ?></td>
                            <td>
                                <a class="" href="<?php echo appUrl('m=Index&a=page&view=add'); ?>&page_id=<?php echo ($item["page_id"]); ?>">编辑</a>
                                <a class="" onclick="return cfirm();" href="<?php echo appUrl('m=Index&a=page&view=del'); ?>&page_id=<?php echo ($item["page_id"]); ?>"></span>删除</a>
                            </td>
                    ...
                    <tr class="no_line">
                        <td colspan="6">
                            <div class="clearfix">
                                <button type="button" class="uio_btn" href="<?php echo appUrl('m=Index&a=page&view=add'); ?>" onclick="localGo(this);">添加</button>
