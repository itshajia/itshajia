...
<div class="container">
    <div class="panel">
        ...
        <div class="con_body">
            ...
            <form action="<?php echo appUrl('m=Index&a=album'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                            <td><input type="checkbox" class="checkbox" name="id[<?php echo ($item["album_id"]); ?>]" /><?php echo ($item["album_id"]); ?></td>
                            ...
                            <td>
                                <a class="" href="<?php echo appUrl('m=Index&a=album&view=pic'); ?>&album_id=<?php echo ($item["album_id"]); ?>">进入相册</a>
                                <a class="" href="<?php echo appUrl('m=Index&a=album&view=add'); ?>&album_id=<?php echo ($item["album_id"]); ?>">编辑</a>
                                <a class="" onclick="return cfirm();" href="<?php echo appUrl('m=Index&a=album&view=del'); ?>&album_id=<?php echo ($item["album_id"]); ?>"></span>删除</a>
                            </td>
                    ...
                    <tr class="no_line">
                        <td colspan="6">
                            <div class="clearfix">
                                <button type="button" class="uio_btn" href="<?php echo appUrl('m=Index&a=album&view=add'); ?>" onclick="localGo(this);">添加</button>
