...
<div class="container">
    <div class="panel">
        ...
        <div class="con_body">
            ...
            <form action="<?php echo appUrl('m=Index&a=news&view=add'); ?>" method="post" id="frm" name="frm">
                <input type="hidden" name="submit" value="1" />
                <table cellpadding="0" cellspacing="0" border="0">
                    <tbody>
                    <tr>
                        <th scope="row" width="130px;">新闻标题：</th>
                        <td width="">
                            <input name="title" class="txt" id="title" value="<?php echo ($obj["title"]); ?>" style="width:350px;" datatype="*"  nullmsg="请填写新闻标题！" />
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" width="130px;">新闻内容：</th>
                        <td class="textarea">
                            <textarea name="description" id="myEditor" datatype="*" nullmsg="请填写新闻内容！"><?php echo ($obj["description"]); ?></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr class="no_line">
                        ...
                        <td>
                            <?php if($obj){ ?>
                            <input type="hidden" name="news_id" id="news_id" value="<?php echo ($obj['news_id']); ?>" />
                            <?php } ?>
