...
<div class="container">
    <div class="panel">
        ...
        <div class="con_header">
            <span class="con_title font_yahei font_b">新闻中心</span>
            <span class="con_title2 font_yahei">列表</span>
        </div>

        <div class="con_body">

            <form action="<?php echo appUrl('m=Index&a=news'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                            <td><input type="checkbox" class="checkbox" name="id[<?php echo ($item["news_id"]); ?>]" /><?php echo ($item["news_id"]); ?></td>
                            ...
                            <td>
                                <a class="" href="<?php echo appUrl('m=Index&a=news&view=add'); ?>&news_id=<?php echo ($item["news_id"]); ?>">编辑</a>
                                <a class="" onclick="return cfirm();" href="<?php echo appUrl('m=Index&a=news&view=del'); ?>&news_id=<?php echo ($item["news_id"]); ?>"></span>删除</a>
                            </td>
                    ...
                    <tr class="no_line">
                        <td colspan="6">
                            <div class="clearfix">
                                <button type="button" class="uio_btn" href="<?php echo appUrl('m=Index&a=news&view=add'); ?>" onclick="localGo(this);">添加</button>
