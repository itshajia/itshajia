...
<div class="container">
    <div class="panel">
        ...
        <div class="con_header">
            <span class="con_title font_yahei font_b">文本素材管理</span>
            <span class="con_title2 font_yahei">列表</span>
        </div>

        <div class="con_body">

            <form action="<?php echo appUrl('m=User&a=textReply'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="" href="<?php echo appUrl('m=User&a=textReply&view=add'); ?>&reply_id=<?php echo ($item["reply_id"]); ?>">编辑</a>
                                <a class="" onclick="return cfirm();" href="<?php echo appUrl('m=User&a=textReply&view=del'); ?>&reply_id=<?php echo ($item["reply_id"]); ?>"></span>删除</a>
                            </td>
                    ...
                    <tr class="no_line">
                        <td colspan="6">
                            <div class="clearfix">
                                <button type="button" class="uio_btn" href="<?php echo appUrl('m=User&a=textReply&view=add'); ?>" onclick="localGo(this);">添加</button>
