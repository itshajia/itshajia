...
<div class="container">
    <div class="panel">
        ...
        <div class="con_body">
            ...
            <form action="<?php echo appUrl('m=User&a=textReply&view=add'); ?>" method="post" id="frm" name="frm">
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <th scope="row" width="130px;">回复内容：</th>
                        <td>
                            <textarea class="txt" style="width:400px; height:100px;margin-top:10px;" name="reply" id="myEditor" datatype="*" nullmsg="请填写回复内容！"><?php echo ($obj["reply"]); ?></textarea>
                        </td>
                    </tr>
                    <tr class="no_line">
                        <th></th>
