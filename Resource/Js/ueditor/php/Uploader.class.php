...
//        "POST" => "文件大小超出 post_max_size 限制" ,
    ...
    private function upFile( $base64 )
    {
        ...
        if ( $this->stateInfo == $this->stateMap[ 0 ] ) {
            /* 修改 by ZX Start */
            if ( !move_uploaded_file( $file[ "tmp_name" ] , $_SERVER['DOCUMENT_ROOT'].'/Uploads/'.$this->fullName ) ) {
    ...
    private function getFolder()
    {
        ...
        /* 修改  by ZX Start */
        $pathStrOriginal = $pathStr;
        $pathStr = $_SERVER['DOCUMENT_ROOT'].'/Uploads/'.$pathStr . '/';
        /* 修改 End */
